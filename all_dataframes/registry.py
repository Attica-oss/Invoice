"""Registry for all dataset builders."""
...
DatasetBuilder = Callable[[], pl.LazyFrame]
...
REGISTRY: DatasetRegistry = {
    ...
    "washing": {
        "washing": washing.build_washing,
    },
    "operations": {
        "ops": operations.build_ops,
        "extramen": operations.build_extramen,
        "hatch_to_hatch": operations.build_hatch_to_hatch,
        "additional_overtime": operations.build_additional,
        "tare_calibration": operations.build_tare,
        "berth_dues": operations.build_berth,
    },
    "netlist": {
    ...
    "miscellaneous": {
        ...
        "truck_to_cccs_via_skiff": miscellaneous.build_truck_to_cccs_via_skiff,
    },
}
